...
fun main(args: Array<String>) {
    ...
    try {
        ...
        runBlocking {
            ...
            // Wait for SDK initialization (settings fetch, StartupQueue unblock).
            // Settings error-tolerance tests need time for the CDN request to
            // fail and the SDK to fall back to defaults before events flow.
            delay(5000)
